...
@SequenceGenerator(name = "seqCategoriaProduto", sequenceName = "seqCategoriaProduto", allocationSize = 1,initialValue = 1)
public class CategoriaProduto implements Serializable {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seqCategoriaProduto")
	private Long id;
