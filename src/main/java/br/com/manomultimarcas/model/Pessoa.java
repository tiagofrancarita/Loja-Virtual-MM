...
@Entity
@Inheritance (strategy = InheritanceType.TABLE_PER_CLASS) //Usado quando há herança/abstração, vai criar a tabelas pelas clases  filhas (Pessoa Fisica e Juridica).
...
public abstract class Pessoa implements Serializable {
	...
	foreignKey = @ForeignKey(value = ConstraintMode.CONSTRAINT, name = "empresaid") )
